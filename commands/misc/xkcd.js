...
module.exports = {
    ...
    execute: async (bot, msg) => {
        try {
            const latest = await snekfetch.get(`https://xkcd.com/info.0.json`);
            const random = await snekfetch.get(`https://xkcd.com/${Math.floor(Math.random() * latest.body.num + 1)}/info.0.json`);
