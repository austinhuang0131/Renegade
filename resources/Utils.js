...
module.exports = {
	...
	resolveTracks: async function (search) {
		try {
			var result = await superagent.get(`http://localhost:8080/loadtracks?identifier=${search}`)
	...
	getPlayer: function (bot, channel) {
